      ...
      <div className="relative z-10 backdrop-blur-[2px] bg-gradient-to-br from-black/5 to-black/20">
        ...
        <div className="px-6 py-8 sm:p-8">
          <p className="text-base text-balance leading-relaxed text-sky-100 sm:text-lg drop-shadow-md mb-4">
            ...
            achieving their exercise goals and fulfilling their potential. From sports injuries to muscular ailments, Brad is abreast of current paradigms and collaborates with local health professionals for a holistic approach to coaching.
          </p>
        </div>
      </div>
